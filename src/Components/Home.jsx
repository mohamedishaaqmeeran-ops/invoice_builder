        ...
        <div className="min-h-screen bg-blue-950 ">
            ...
            <div className="max-w-6xl mx-auto px-6">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-xl text-white italic">  Create and download invoices in seconds. </p>
                ...
                <div className="grid md:grid-cols-3 gap-8 mb-12">
                    ...
                    <div className="bg-blue-200 p-6 rounded-3xl text-center hover:-translate-y-2 transition">
                        <h3 className="text-xl font-bold mb-2"> Shop Details  </h3>


                        <p className="text-gray-700"> Add shop name, address and contact details.</p>
                    ...
                    <div className="bg-indigo-200 p-6 rounded-3xl text-center hover:-translate-y-2 transition">
                        ...
                        <p className="text-gray-700">Enter customer details easily.</p>
                    </div>
                    ...
                    <div className="bg-purple-200 p-6 rounded-3xl text-center  hover:-translate-y-2 transition">
                        ...
                        <p className="text-gray-700">Add products with price and quantity.</p>

                    </div>


                    <div className="bg-green-200 p-6 rounded-3xl text-center hover:-translate-y-2 transition">
                        <h3 className="text-xl font-bold mb-2">  Auto Calculation</h3>


                        <p className="text-gray-700">Automatic total calculation. </p>
                    ...
                    <div className="bg-yellow-200 p-6 rounded-3xl text-center hover:-translate-y-2 transition">
                        ...
                        <p className="text-gray-700">Download invoice as PDF. </p>
                ...
                <div className="bg-white  p-6 rounded-3xl text-center border-3 border-yellow-500">
                    ...
                    <h3 className="text-xl font-bold mb-2"> Auto Calculation </h3>
                    <p className="text-gray-600"> Automatic total calculation.</p>
                ...
                <div className="bg-white p-6 rounded-3xl  text-center border-3 border-yellow-500">
                    ...
                    <p className="text-gray-600">Export invoice as PDF.</p>
